    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-6 flex-1">
        <Card className="shadow-lg border-0">
          <CardHeader className="bg-[var(--maroon)] text-white p-6">
          ...
          <CardContent className="p-6 bg-white">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              ...
              <div>
                ...
                <Badge className="bg-[var(--success-green)] hover:bg-[var(--success-green)] text-white px-4 py-2 text-base rounded-full">
                  <span className="mr-1">●</span> Vigente
                </Badge>
              </div>
            ...
            {/* Seguros Card */}
            <Card className="shadow-sm border-0 mb-6 max-w-md">
              <CardHeader className="bg-[var(--success-green)] text-white text-center py-4">
