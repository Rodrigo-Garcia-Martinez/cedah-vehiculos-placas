...
import { FileText, CheckCircle, XCircle, Calendar, Car, Truck, PlusCircle } from 'lucide-react';
...
export default function RegisterPlaca() {
  ...
  const tiposTransporte = [
    'Automóvil', 'Camión', 'Camioneta', 'Motocicleta', 'Autobús', 'Taxi', 'Carga'
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setResult({ success: false, message: data.error || 'Error desconocido al registrar.' });
      }
    } catch (error) {
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        ...
        <DialogContent className="sm:max-w-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 py-4">
                ...
                <div>
                    <label htmlFor="numeroplaca" className="block text-sm font-medium text-gray-700 mb-2">
                ...
                <div>
                    <label htmlFor="tipoTransporte" className="block text-sm font-medium text-gray-700 mb-2">
                ...
                <div>
                    <label htmlFor="vigencia" className="block text-sm font-medium text-gray-700 mb-2">
